...
class GroupController {
    ...
    private function sendInvitation($email) {
        ...
        $body = "Hi there, \r\n\r\n"
              . "$user_mail sents you an invitation to join his/her football betting group on moeby.ch . \r\n"
        ...
        $transport = \Swift_SmtpTransport::newInstance('mail.cyon.ch', 465, "ssl")
        ...
        $message = \Swift_Message::newInstance("TippTopf: $user_mail has invited you to join his football betting group!")
                ->setFrom(array('tipptopf@moeby.ch' => 'TippTopf'))
                ->setTo(array($email))
                ->setBody($body);
